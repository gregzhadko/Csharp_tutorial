...
namespace Lesson2
{
    class Lesson2
    {
        static void Main(string[] args)
        {
            ...
            double d = 1.2; // так называемый тип данных с плавающей точкой, а если по русски то просто для хранения дробей.
            float f = 1.2f; // практически тоже что и double, есть кое-какие различия, но пока об этом не надо заморачиваться
            char c = 'c'; // это просто символ, внимательный читатель может спросить, связано ли это как-то с типом string.
            ...
            //if (d > 10) // Это условие. Как нетрудно догадаться, если условие внутри круглых скобок верно (равно true), то будут выполняться операции внутри фигурных скобок
            //{
            ...
            if (name == "Гриша")
            {
                Console.WriteLine("Гриша Хорош");
            }
            else if (name == "Аня")
            {
                Console.WriteLine("Аня Хороша");
            }
            else
            {
                Console.WriteLine(name + " неизвестно для меня");
            }
            Console.ReadLine();
