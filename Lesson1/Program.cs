...
namespace Lesson1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string hello = "hello";
            string world = "world";
            //Необходимо написать одну строку которая бы выводила на экран "hello world":


            //Задание 2:
            //Написать программу которая спрашивает имя пользователя, пользователь его вводит, и программа пишет: Привет, <имя_пользователя>
